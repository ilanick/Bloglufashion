...
const fetchData = async()=>{                        // INCORPORANDO FETCH
    try{
...
const pintarFooter = () => {
        ...
        if(Object.keys(carrito).length === 0){
            footer.innerHTML = `
            <th scope="row" colspan="5">Tu carrito esta vacio. </th>
            `
            return
        }
        ...
        btnVaciar.addEventListener('click', ()=>{
            ...
            Swal.fire({                   // MENSAJE CUANDO ELIMINAS EL CARRITO
                ...
                if(result.isConfirmed) {
                    console.log("SE APRETÓ EL BOTÓN DE OK");
                }
               if(result.isDismissed) {
            console.log("SE APRETÓ EL BOTÓN DE CANCELAR");
        }
    })
        })
    }
